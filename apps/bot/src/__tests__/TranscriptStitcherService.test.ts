...
describe("TranscriptStitcherService", () => {
  test("emits only final turns as conversation-ready", async () => {
    ...
    stitcher.acceptTurn({ guildId: "g1", channelId: "c1", sessionId: "s1", userId: "u1", text: "hel", isFinal: false, receivedAt: 1 });
    stitcher.acceptTurn({ guildId: "g1", channelId: "c1", sessionId: "s1", userId: "u1", text: "hello", isFinal: true, receivedAt: 2 });
